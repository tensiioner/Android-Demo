...
class DBHelper(context: Context, factory: SQLiteDatabase.CursorFactory?) :
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        val query = ("CREATE TABLE " + TABLE_NAME + " ("
                ...
                Author + " TEXT DEFAULT GOOD," +
                Title + " TEXT DEFAULT 1," +
                Description + " TEXT DEFAULT 1," +
                URL + " TEXT DEFAULT 1," +
                URLTOIMAGE + " TEXT DEFAULT 1," +
                PUBLISHEDAT + " TEXT DEFAULT 1" + ")")
    ...
    fun addName(author: String, title : String, description: String, url: String, urltoimage : String, publishedat : String ){
    ...
    companion object{
        ...
        private val DATABASE_NAME = "NewsTable"
